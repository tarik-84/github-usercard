...
*/
axios.get("https://api.github.com/users/tarik-84")
  .then(response => {
...
*/
axios.get("https://api.github.com/users/tarik-84/followers")
  .then(response => {
  //console.log(response);  
...
function userCard(obj) {
  ...
  cardInfo.appendChild(public_repos);
  ...
  public_repos.textContent = `Repos: ${obj.public_repos}`
